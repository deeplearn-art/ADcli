...
ControlNetModel.from_pretrained('lllyasviel/control_v11p_sd15_openpose',cache_dir='/src/.cache/huggingface/hub', torch_>OpenposeDetector.from_pretrained('lllyasviel/Annotators',cache_dir='/src/.cache/huggingface/hub')
